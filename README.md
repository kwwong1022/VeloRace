...
<p>The Last function is ride result, which generates a result graphic based on the ride information by using custom view. The result graph contains 2 parts:
